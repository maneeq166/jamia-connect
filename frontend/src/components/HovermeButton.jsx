...
export function HovermeButton() {
  ...
  return (
    <button onClick={()=>nav("/chat/messages")} className="group relative inline-flex h-[30px] items-center justify-center rounded-full bg-jmi-500 py-1 pl-6 pr-14 font-medium text-jmi-100">
